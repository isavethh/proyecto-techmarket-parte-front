...
export default function Perfil() {
  return (
    <div className="min-h-screen bg-[#07111f] text-cyan-50">
          ...
          <article className="rounded-3xl border border-cyan-100/10 bg-white/5 p-6">
            ...
            <div className="mt-5 grid gap-4 sm:grid-cols-3">
              {contactChannels.map((channel) => (
                <div key={channel.label} className="rounded-2xl border border-cyan-100/10 bg-slate-950/30 p-4">
          ...
          <article className="rounded-3xl border border-cyan-100/10 bg-white/5 p-6">
            ...
            <div className="mt-5 space-y-3">
              {schedules.map((schedule) => (
                <div key={schedule.day} className="flex items-center justify-between gap-4 rounded-2xl border border-cyan-100/10 bg-slate-950/30 p-4">
              ...
              <div key={branch.name} className="rounded-2xl border border-cyan-100/10 bg-slate-950/30 p-5">
                ...
                <div className="mt-4 space-y-3 text-sm text-cyan-100/80">
                  ...
                  <div>
                    ...
                    <p className="mt-1 leading-7">{branch.hours}</p>
                  </div>
                </div>
              </div>
            ))}
