...
import { recentActivity, specialistKpis, specialistReviews, starsLabel } from "../specialistData";
    ...
    <SpecialistShell sectionLabel="Reputacion" statusMessage="Indicadores de confianza y resenas activas">
      ...
      <section className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
        <article className="rounded-2xl border border-cyan-100/10 bg-slate-950/35 p-4">
          ...
          <p className="mt-2 text-2xl font-bold text-white">{specialistKpis.averageRating} / 5</p>
        ...
        <article className="rounded-2xl border border-cyan-100/10 bg-slate-950/35 p-4">
          ...
          <p className="mt-2 text-2xl font-bold text-white">{specialistKpis.totalReviews}</p>
        ...
        <article className="rounded-2xl border border-cyan-100/10 bg-slate-950/35 p-4">
          ...
          <p className="mt-2 text-2xl font-bold text-white">{specialistKpis.jobsCompleted}</p>
